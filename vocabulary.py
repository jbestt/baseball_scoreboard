...
def sanitizer(text):
    ...
    text = text.replace("red birds","cardinals")
    ...
    text = text.replace("orange birds","orioles")
    text = text.replace("asstros","astros")
    text = text.replace("angles","angels")
    text = text.replace("halos","angels")
    ...
    text = text.replace("snakes","d-backs")
    text = text.replace("brew crew","brewers")
    text = text.replace("brewcrew","brewers")
    text = text.replace("broyals","brewers")
    text = text.replace("pads","padres")
    text = text.replace("friars","padres")
    text = text.replace("buccos","pirates")
    text = text.replace("bucs","pirates")
    text = text.replace("vagiants","giants")
    text = text.replace("beantown","RED")
    text = text.replace("beaneaters","RED")
    text = text.replace("sawx","RED")
    ...
    text = text.replace("jays","BLUE")
    text = text.replace("blue birds","BLUE")
    text = text.replace("los doyers","dodgers")
    text = text.replace("doyers","dodgers")
    text = text.replace("bravos","braves")
    text = text.replace("barves","braves")
    text = text.replace("cubbies","cubs")
    text = text.replace("native americans","indians")
    text = text.replace("tribe","indians")
    text = text.replace("engines","indians")
    text = text.replace("wahoos","indians")
    text = text.replace("cockies","rockies")
    text = text.replace("kitties","tigers")
    text = text.replace("cats","tigers")
    text = text.replace("fish","marlins")
    return text
